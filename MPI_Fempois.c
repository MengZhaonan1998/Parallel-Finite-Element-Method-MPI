...
void Setup_MPI_Datatypes(FILE * f)
{
  ...
  //MPI_Allreduce(&sendNumber,&maxRS,1,MPI_INT,MPI_MAX,grid_comm);
 
  //MPI_Allreduce(&sendNumber,&minRS,1,MPI_INT,MPI_MIN,grid_comm);


  //printf("Number of data to be sent: %i\n", maxRS);
  //printf("Number of data to be recv: %i\n", minRS);
...
//  double starttime_co; // computation
//  double endtime_co;
  
//  double time_bx = 0.0; // border exchange
//  double time_gc = 0.0; // global comm
//  double t_comp;
//  double t_comm;

//  starttime_co = MPI_Wtime();
...
//  endtime_co = MPI_Wtime();
  
//  t_comp = endtime_co - starttime_co - time_bx - time_gc;
//  t_comm = time_bx + time_gc;

//  printf("Time spent in computation: %f\n", t_comp);
//  printf("Time spent in border exchanging: %f\n", t_comm);
//  printf("ration of t-comp/t-comm: %f\n", t_comp/t_comm);
